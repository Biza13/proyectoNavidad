...
#Este sera el servicio para el contenedor json server
resource "aws_ecs_service" "json_server_service" {
  ...
  load_balancer {
    ...
    container_port   = 3000  # O el puerto que se va a usar para tu API
  }
}